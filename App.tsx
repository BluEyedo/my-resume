        ...
        <main className="p-6 lg:p-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-10 animate-fade-in">
              <section>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 relative overflow-hidden">
                  <Quote
                    size={64}
                    className="absolute top-4 right-4 text-slate-100 -z-0"
                  />
                  <p className="text-lg md:text-xl leading-relaxed text-slate-600 relative ">
                    {resumeData.summary}
                  </p>
                </div>
              </section>
          ...
          {activeSection === "education" && (
            <div className="animate-fade-in">
              ...
              <h2 className="text-3xl font-bold text-slate-900 mb-8 mt-14">
