  ...
  experience: [
    {
      ...
      description: (
        <p>
          After completing my academic internship at Islamic Systems Corporation
          (I-Corp), where I received strong evaluations for discipline, work
          ethic, and adaptability, I was hired immediately after graduation and
          have since been working at the company for two years as a full-time
          developer. During this period, I have been involved in developing and
          maintaining web and mobile applications using technologies such as
          HTML, CSS, JavaScript, Tailwind CSS, Flutter, Next.js, .NET, and
          Microsoft SQL Server. My role includes implementing frontend
          interfaces, collaborating with backend developers and designers,
          optimizing system performance, and contributing to digital solutions
          used by various organizations across Thailand. This experience has
          strengthened my technical abilities while allowing me to work
    ...
    },
    {
      ...
      description: (
        <p>
          Built responsive websites and dashboards starting from basic static
          development using HTML, CSS, JavaScript, and Tailwind CSS, and
          progressing to modern frameworks such as .NET and Next.js. Experience
          includes both client-side data management using local storage and
          server-side data handling with Microsoft SQL Server. Deployed projects
          on paid hosting platforms as well as GitHub Pages for free unpaid and
          static applications.{" "}
          <a
    ...
    },
    {
      ...
      description: (
        <p>
          Provided freelance graphic design services for various clients from
          Saudi Arabia and Thailand, creating logos, marketing materials, and
          social media graphics. Collaborated with clients to understand their
          vision and deliver designs that met their needs. you can have a look
          at my portfolio on Instagram{" "}
          <a
            className="text-blue-600 hover:text-blue-800"
    ...
    },
    {
      id: "4",
      company:
        "Mutawif Foundation for Hajj Pilgrims from Southeast Asia SEA (Saudi Arabia)",
      ...
      description: (
        <p>
          Responsible for data entry of Hajj pilgrims' information and also
          montoring the numbers of pilgrims in Hajj season each day, and also
          finding how many buses needed to transport them to the holy sites
          using Microsoft Excel, Additionally handled some Graphic design tasks,
          like creating creating visual explanation of plans on maps using
          graphics, creating Operational and Workforce Structures, and also
          creating PowerPoints for presenting and explaining Operational Plans
          for field personnel and other related parties.
        </p>
      ),
      technologies: [
